...
export const MAP_LSHAPE: GameMap = {
  ...
  path: [
    ...
    // Turn 6: Go left (U-turn)
    p(6, 12), p(6, 11), p(6, 10), p(6, 9), p(6, 8), p(6, 7),
    // Turn 7: Go up
    p(5, 7), p(4, 7), p(3, 7), p(2, 7),
    // Turn 8: Go right
    p(2, 8), p(2, 9), p(2, 10), p(2, 11), p(2, 12), p(2, 13), p(2, 14), p(2, 15),
    // Turn 9: Go down
    p(3, 15), p(4, 15), p(5, 15), p(6, 15), p(7, 15), p(8, 15), p(9, 15), p(10, 15), p(11, 15), p(12, 15), p(13, 15), p(14, 15),
